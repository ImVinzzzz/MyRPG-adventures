...
export default function Footer(): ReactElement {
  return (
    <footer className="border-t border-[#2B3D34] bg-[#0D1814] px-6 py-6 text-center text-xs text-[#7C8A83] flex flex-col sm:flex-row items-center justify-between gap-4 max-w-6xl mx-auto">
      <p>
